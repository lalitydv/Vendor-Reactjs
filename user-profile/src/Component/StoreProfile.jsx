...
<select id="countries" class="  text-black text-sm   ">
  ...
  <option value="DE">Germany</option>
          ...
          <img src={d2} alt="" className='rounded-xl w-32' />
          </div>
          <div className=' py-4'>
            
          <h1 className='text-xs font-bold'> Chobani Complete Vanilla Greek Yogurt</h1>

          <div class="flex items-center space-x-1">
              <svg class="w-3 h-3 text-light-yellow" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
          ...
          <div className='flex  '>
            <div className='w-28  mt-2 px-2   '>
          <img src={d3} alt="" className='rounded-xl w-32' />
          </div>
          <div className=' py-4'>
          ...
          <div className='flex  '>
            <div className='w-28  mt-2 px-2   '>
          <img src={d4} alt="" className='rounded-xl w-32' />
          </div>
          <div className=' py-4'>
