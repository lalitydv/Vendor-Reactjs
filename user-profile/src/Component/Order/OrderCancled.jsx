...
export const OrderCancled = () => {
 ...
 1234567890</td>
             ...
             <br />
             <p className='bg-lightred text-red rounded-lg px-2 w-14 text-center'>unpaid</p>
             </td>
             <td className="  ">
             <p className='bg-lightred text-red  py-2 px-2 w-28 text-center rounded-md'> Canceled</p>
             </td>
