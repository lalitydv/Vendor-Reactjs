...
<div className="rounded-lg grow    md:flex gap-6 mt-8">
  ...
  <div className="shadow-md shadow-gray-1  rounded-lg flex-grow p-2 md:w-52 w-[100%] h-24 flex mt-2">
    <div className="flex gap-8  items-center ">
      ...
      <div className="w-[60%]">
        <p className="text-blue font-bold text-[12px]">Pending</p>
        <p className="text-blue font-bold text-[12px] flex justify-end">20</p>
      </div>
    </div>
  </div>
  {/* card 2 */}
...
<div className="rounded-lg grow    md:flex gap-5 mt-8">
  ...
  <div className="shadow-md shadow-gray-1  rounded-lg flex-grow p-2 md:w-52 w-[100%] h-24 flex mt-2">
    <div className="flex gap-8  items-center ">
      ...
      <div className="w-[60%]">
        <p className="text-blue font-bold text-[12px]">Delivered</p>
        <p className="text-blue font-bold text-[12px] flex justify-end">20</p>
      </div>
    </div>
  </div>
  ...
  <div className="shadow-md shadow-gray-1  rounded-lg flex-grow p-2 md:w-52 w-[100%] h-24 flex mt-2">
    <div className="flex  gap-8 items-center ">
      ...
      <div className="w-[60%]">
        <p className="text-blue font-bold text-[12px]">Canceled</p>
        <p className="text-blue font-bold text-[12px] flex justify-end">20</p>
      </div>
    </div>
  </div>
  ...
  <div className="shadow-md shadow-gray-1  rounded-lg flex-grow p-2 md:w-52 w-[100%] h-24 flex mt-2">
    <div className="flex gap-8 items-center ">
      ...
      <div className="w-[60%]">
        <p className="text-blue font-bold text-[12px]">Returned</p>
        <p className="text-blue font-bold text-[12px] flex justify-end">20</p>
      </div>
    </div>
  </div>
  ...
  <div className="shadow-md shadow-gray-1  rounded-lg flex-grow p-2 md:w-52 w-[100%] h-24 flex mt-2">
    <div className="flex gap-8 items-center ">
      ...
      <div className="w-[60%]">
        <p className="text-blue font-bold text-[12px]">Failed</p>
        <p className="text-blue font-bold text-[12px] flex justify-end">20</p>
      </div>
    </div>
  </div>
      ...
      <table className="w-full mt-4 text-sm text-left  text-gray-1 ">
        ...
        <tbody>
          <tr className="bg-white  border-b-4  border-gray ">
            ...
            <td className="py-5 ">12 Oct 2022 / 07:01 AM</td>
            <td className="py-5 ">Name <br />
1234567890</td>
            <td className="py-5 ">$5,400.00</td>
            <td >
            <p className='bg-lightgreen text-green py-2 px-2 w-20 rounded-md'>Packaging</p>
            </td>
...
1234567890</td>
            <td className="py-5 ">$5,400.00</td>
            <td className="  ">
            <p className='bg-lightyellow text-yellow py-2 px-2 w-20 rounded-md'>Packaging</p>
            </td>
...
1234567890</td>
            <td className="py-5 ">$5,400.00</td>
            <td className="  ">
            <p className='bg-lightpink text-pink py-2 px-2 w-20 rounded-md'>Packaging</p>
            </td>
...
1234567890</td>
            <td className="py-5 ">$5,400.00</td>
            <td className="  ">
            <p className='bg-greylight text-gray-1 py-2 px-2 w-20 rounded-md'>Packaging</p>
            </td>
