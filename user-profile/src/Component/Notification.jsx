...
import {AiFillFileText ,AiFillSmile , AiOutlinePaperClip ,AiOutlineSend} from "react-icons/ai"
                                            ...
                                            <div className="grow bg-white p-4 rounded-lg">
                                              ...
                                              <div className="flex  justify-between rounded-lg items-center border-2 border-green p-2">
                                                <div className="flex justify-center items-center">
                                                  ...
                                                  <div className="ml-2">
                                                    <p className="text-md text-darkblak font-bold">neha sign</p>
                                                    <div className="flex justify-center items-center">
                                                      <img src={img} alt="photo" className="mr-2" />
                                                      <span className="text-sm text-darkblak"> photo
                                                      </span>
                                                    </div>
                                                  </div>
                                                </div>
                                                <div className="flex justify-between flex-col items-end">
                                                  <div>
                                                    ...
                                                    <BsThreeDots className="text-darkblak"  /> </div>
                                              ...
                                              <div className="mt-3 flex justify-between rounded-lg items-center border-[1px] border-gray p-2">
                                                ...
                                                <div className="flex justify-between flex-col items-end">
                                                  <div>
                                                    <div  className=" focus:outline-none">   <BsThreeDots className="text-darkblak"  /> </div>
                                                ...
                                                <div className="flex justify-center items-center">
                                                  ...
                                                  <div className="ml-2">
                                                    ...
                                                    <div className="flex justify-center items-center">
                                                      ...
                                                      <span className="text-darkblak text-sm"> vedio
                                                      </span>
                                                    </div>
                                                  </div>
                                                </div>
                                              ...
                                              <div className="mt-3 flex justify-between rounded-lg items-center border-[1px] border-gray p-2">
                                                <div className="flex justify-center items-center">
                                                  ...
                                                  <div className="ml-2">
                                                    ...
                                                    <div className="flex justify-center items-center">
                                                    <img src={img} alt="photo" className="mr-2" />
                                                      <span className="text-darkblak text-sm"> photo
                                                      </span>
                                                    </div>
                                                  </div>
                                                </div>
                                            ...
                                            <div className="flex-grow">
                                              <div className="flex h-screen flex-col bg-gray">
                                                      ...
                                                      <div>
                                                        <div className="flex items-center">
                                                          ...
                                                          <div className="ml-2 flex-col">
                                                            <p className="text-[14px] m-0 p-0">filename</p>
                                                            <p className="text-[12px] m-0 p-0">(546kb)</p>
                                                          </div>
                                                        </div>
                                                        <div className="flex gap-12 justify-between">
                                                          <a href="/images/myw3schoolsimage.jpg" className="text-blue text-sm" download>download</a>
                                                          <a href="#" className="text-blue text-sm">view</a>
                                                        </div>
                                                      </div>
                                                    </div>
                                                ...
                                                <div className="relative flex items-center p-4">
                                                  <input type="text" placeholder="Type your message..." className="w-full rounded-3xl border  pl-16 py-2" />
