    ...
    <div className="bg-white rounded-xl shadow-md p-2 w-full">
      <div className="md:flex grid  md:gap-10 gap-4 my-4 ">
        <div className=" w-full">
          <label className="text-blue font-semibold">Type</label>
          <select
            name="cars"
            id="cars"
            style={{ width: "100%" }}
          ...
          >
            <option value="volvo">Discount on Purchase </option>
      ...
      <div className="md:flex grid  md:gap-8 gap-4 my-4">
        <div className="grow   w-full">
          <label className="text-blue font-semibold">Code</label>
          <input
            type="text"
            name=""
            id=""
        ...
        <div className="grow w-full">
          <label className="text-blue font-semibold">Discount Type</label>
          <select
            name="cars"
            id="cars"
            style={{ width: "100%" }}
      ...
      <div className="md:flex grid  md:gap-8 gap-4 my-4 ">
        <div className="grow  w-full">
          <label className="text-blue font-semibold">Start Date</label>
          <input
            type="date"
            name=""
            id=""
        ...
        <div className="grow  w-full">
          <label className="text-blue font-semibold">Expire date</label>
          <input
            type="date"
            name=""
            id=""
      ...
      <div className="md:flex grid  md:gap-8 gap-4 my-4 ">
        <div className="grow  md:w-[50%] w-[100%]">
          <label className="text-blue font-semibold">limit for same user</label>
          <input
            type="text"
            name=""
            id=""
        ...
        <div className="grow  md:w-[50%] w-[100%]">
          <label className="text-blue font-semibold">minimum purchse</label>
          <input
            type="text"
            name=""
            id=""
      ...
      <div className="flex  items-end justify-between gap-4 my-4  ">
        <div className="grow  md:w-[50%] w-[100%]">
          <label className="text-blue font-semibold">discount</label>
          <input
            type="text"
            name=""
            id=""
      ...
      <table className="w-full mt-4 text-sm text-left  text-gray-1 ">
        ...
        <tbody>
          <tr className="bg-white  border-b-4  border-gray ">
            <td className="py-5 text-red">Discount On Purchase</td>
