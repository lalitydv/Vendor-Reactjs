...
<select id="countries" class="  text-blue text-sm font-bold  mx-2  ">
  ...
  <option value="DE">Germany</option>
                      ...
                      <button className="bg-blue text-white md:px-6 rounded-xl py-2" onClick={handleClick}>
                        add New Product
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-3xl   w-full">
                    ...
                    <div className="bg-white rounded-md shadow-md ">
                      <div className="flex justify-between items-center md:flex-row flex-col my-2 p-2">
                        ...
                        <div onClick={handleClicklimited} className="flex border-2 items-center border-blue text-blue font-bold px-3 rounded-md">
                          <AiOutlinePlusCircle className="font-semibold " />{" "}
                          Limited Stocks
                        </div>
                        <div onClick={handleClick} className="flex border-2 items-center border-blue text-blue font-bold px-3 rounded-md">
                      ...
                      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                          <tr class="bg-white  dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4 "> <span className="bg-lightgreen text-green font-bold p-2  rounded-sm">Status</span></td>
                            <td class="px-6 py-4 ">
                              <div
