...
"
            >
              <ul className="flex flex-col py-10 px-14 mb-10 space-y-1">
                <li>
                  <div className=" my-10 relative item-center justify-center  flex flex-row items-center h-11 focus:outline-none  dark:hover:bg-gray text-white-600 hover:text-white-800 border-l-4 border-transparent hover:border-blue-500 dark:hover:border-gray-800 pr-6">
                ...
                {/* <li>
                  <div>
                    <div className="relative  flex flex-row items-center h-11 focus:outline-none 
...
"
                    ...
                    {marketdrops && (
                      <div className="flex flex-col ml-5 my-2 items-center">
                        <div className="bg-TextGreen w-full text-black  rounded-lg">
                          {order.map((item, inds) => {
                            return (
                              <Link to={item.path}>
                                <div
                                  className="hover:bg-blue hover:text-white px-5 rounded-md focus:text-blue flex py-2 items-center"
                                  key={inds}
                                >
                                  <h3>{item.icon}</h3>
                      ...
                      <div className="bg-TextGreen w-full text-black  rounded-lg">
                        {product.map((items, ind) => {
                          return (
                            <Link to={items.path}>
                              <div
                                className="hover:bg-blue hover:text-white px-5 rounded-md flex py-2 items-center"
                                key={ind}
                              >
                                <h3>{items.icon}</h3>
