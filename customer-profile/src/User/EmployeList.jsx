      ...
      <div className="flex flex-col md:mx-4 mx-2 gap-5">
            ...
            <div className="bg-white rounded-xl  my-10   items-center   p-2   shadow-md">
              <div className="relative overflow-x-auto ">
                <table className=" w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                  ...
                  <tbody>
                    <tr
                      className="bg-white  border-b-4  border-gray  "
                      onClick={() => setShowModal(true)}
                    >
                      <td className="py-5 px-5">1</td>
                      <td className="py-5 px-5">1234567</td>
                      <td className="py-5 px-5">Employee Name</td>
                      <td className="py-5 px-5">demo@gmail.com</td>
                      <td className="py-5 px-5">+1234567890</td>
                      <td className="py-5 px-5">city</td>
                      <td className="py-5 px-5">District</td>

                      <td className="py-5 px-5">Pan no.</td>

                      <td className="py-5 px-5">Balance</td>
                      <td className="py-5 px-5 text-orange">Show</td>
        ...
        focus:ring-blue-500 focus:border-blue-500 focus:ring-1"
                    ...
                    <tr className="bg-white border-b-4  border-gray  ">
                      ...
                      <td className="py-5 px-5">Balance</td>
                      <td className="py-5 px-5 text-yellow">Show</td>
                      <td className="py-5 px-5 ">
