                  ...
                  <div className="bg-white rounded-xl gap-x-64 py-10 md:flex w-72  items-center md:w-full  p-4 overflow-hidden  shadow-md">
                    <div>
                      <div className="my-4">
                        ...
                        <input
                          ...
                          className=" rounded-xl border-4 border-gray md:px-10 px-4 md:w-96 py-2"
                        />
                      </div>
                      <div className="my-4">
                        <h1>Employee Name</h1>
                      ...
                      <div className="my-4">
                        ...
                        <input
                          ...
                          name=""
                          id=""
                          placeholder="superduper@gmail.com"
                          className=" rounded-xl border-4 border-gray md:px-10 px-4 md:w-96 py-2"
                        />
                      </div>
                      <div className="my-4">
                      ...
                      <div className="md:flex gap-8 my-4 ">
                        <div>
                          ...
                          <input
                            ...
                            id=""
                            placeholder="123456"
                            className=" rounded-xl border-4 border-gray md:px-10 px-4 md:w-44 py-2"
                          />
                        </div>
                    ...
                    <div>
                      <div className="bg-white rounded-xl  py-6  text-center   px-10 overflow-hidden  shadow-xl">
                        <h1 className="font-bold">Upload your files</h1>
                      ...
                      <div className="flex my-4">
                        <h1 className="font-bold">Google Authenticator</h1>
                      </div>
                      <div>
                        <h1>
