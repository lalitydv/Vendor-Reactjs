            ...
            <div className="bg-white md:rounded-l-full w-72 md:w-full  overflow-hidden  shadow-md">
              <div className="md:flex md:justify-between  grid md:gap-0 gap-4 items-center">
                    ...
                    <div className="flex items-center">
                      <label
                        for="countries"
                        class="block 2xl:text-xl  text-sm font-medium text-gray-1 "
                      >
                        Show
                      </label>
                      <select id="countries" class="  text-black text-sm   2xl:text-xl ">
                    ...
                    <table className="w-full text-sm text-left  border-gray  border-4 text-gray-500 ">
                      <thead className="     ">
                        <tr className="border-b-4  border-gray text-xs">
                          ...
                          <th
                            scope="col"
                            className="  border-x-4 py-3 md:px-14 px-4"
                          >
                            Role Name
                          </th>
                      ...
                      <tbody>
                        <tr className="bg-white  border-b-4  border-gray ">
                          ...
                          <td className="py-5 md:px-14 px-4">Super Admin</td>
                          <td className="py-5 md:px-32 px-10">Super Admin</td>
                          <td className="py-5 md:px-20 px-6">Active</td>
                          <td className="py-5 md:px-20 px-6 flex gap-2">
                            <MdModeEdit className="text-blue border-2  w-6 h-6 rounded-md " />
                            <MdDelete className="text-red border-2  w-6 h-6 rounded-md" />
                          </td>
                        </tr>

                        <tr className="bg-white  border-b-4  border-gray ">
                          <td className="py-5 px-6">1</td>
                          <td className="py-5 md:px-14 px-4">Default-Emp</td>
                        ...
                        <tr className="bg-white  border-b-4  border-gray ">
                          <td className="py-5 px-6">1</td>
                          <td className="py-5 md:px-14 px-4">super Emp</td>
                          <td className="py-5 md:px-32 px-10">super Emp</td>
                          <td className="py-5 md:px-20 px-6">Active</td>
                          <td className="py-5 md:px-20 px-6 flex gap-2">
                            <MdModeEdit className="text-blue border-2  w-6 h-6 rounded-md " />
                            <MdDelete className="text-red border-2  w-6 h-6 rounded-md" />
                        ...
                        <tr className="bg-white  border-b-4  border-gray ">
                          <td className="py-5 px-6">1</td>
                          <td className="py-5 md:px-14 px-4">600001</td>
                          <td className="py-5 md:px-32 px-10">Super Admin</td>
                          <td className="py-5 md:px-20 px-6">Active</td>
                          <td className="py-5 md:px-20 px-6 flex gap-2">
                            <MdModeEdit className="text-blue border-2  w-6 h-6 rounded-md " />
