                              ...
                              <tbody>
                                <tr className="bg-white  border-b-4  border-gray ">
                                  ...
                                  <td className="py-5 px-6 ">
                                    $5,400.00
                                    <br />
                                    <p className="bg-lightred text-red rounded-lg px-2 w-14 text-center">
                                      update
                                    </p>
                                  </td>
                                  <td className="  ">
                                    <p className="bg-lightyellow text-yellow py-2 px-2 w-40 text-center rounded-md">
                                      {' '}
                                      Out For Delivery
                                    </p>
                                  </td>
                                ...
                                <tr className="bg-white  border-b-4  border-gray ">
                                  ...
                                  <td className="py-5 px-6 ">
                                    $5,400.00 <br />
                                    <p className="bg-lightgreen text-green rounded-lg px-2 w-14 text-center">
                                      paid
                                    </p>
                                  </td>
                                  <td className="  ">
